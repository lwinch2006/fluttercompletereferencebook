...
void collections2() {
  ...
  final set11 = {for (var i = 1; i < 5; i++) i, if (condition1) 10};
  print('set11: $set11');
}
...
void collections3() {
  ...
  final list1 = [1, 2, 3];
  final map5 = Map<String, int>.fromIterable(list1,
      key: (element) => element.toString(), value: (element) => element);
  print('map5: $map5');
...
void collections5() {
  ...
  final value2 = list1.fold<int>(
      0, (currentNumber, element) => currentNumber + '$element'.length);
...
void collections7() {
  // Fixed length unmodifiable list as const variable
  const testList1 = [1, 2, 3];
  print('testList1: $testList1');

  // Fixed length unmodifiable list as final variable
  final testList3 = List<int>.unmodifiable([1, 2, 3]);
  print('testList3: $testList3');

  // Fixed length modifiable list as final variable
  final testList2 = List<int>.of([1, 2, 3], growable: false);
  testList2[0] = 111;
  print('testList2: $testList2');

  // Growable modifiable list as final variable
  final testList4 = [1, 2, 3];
  testList4.add(4);
