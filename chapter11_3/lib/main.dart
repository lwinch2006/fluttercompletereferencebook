                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Align(
                            child: CupertinoSegmentedControl<int>(
                              ...
                              groupValue: _cupertinoSegmentedControlGroupValue,
                            ),
                          ),
                        ),
                        const Padding(
                          padding: EdgeInsets.symmetric(vertical: 10),
                          child: Align(child: MyProgressBar(progressValue: 63)),
                        ),
                        const Padding(
                          padding: EdgeInsets.symmetric(vertical: 10),
                          child: Opacity(
                        ...
                        const Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Widget that is built by FutureBuilder:',
                                style: TextStyle(color: Colors.grey),
                              ),
                              SizedBox(width: 10),
                              MyFutureBuilderWidget(),
                            ],
                          ),
                        ),
                        const Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Widget that is built by StreamBuilder:',
                                style: TextStyle(color: Colors.grey),
                              ),
                              SizedBox(width: 10),
